...
namespace Plataforma.Controllers
{
    public class StoreContextSeed
    {
        ...
        public static async Task SeedAsync(ApplicationDbContext context, ILoggerFactory loggerFactory)
        {
            ...
            try {
                 /*               var empresasdata = 
                      File.ReadAllText("C:/Users/joaov/Desktop/Projects/GitHub/Plataforma-ASPNET-CORE-5.0/Plataforma/Data/empresas2021.json");
                ...
                foreach (var item in empresas)
                 ...
                 var trabajadoresdata =
                        File.ReadAllText("C:/Users/joaov/Desktop/Projects/GitHub/Plataforma-ASPNET-CORE-5.0/Plataforma/Data/parte1.json");

                 var trabajadores = JsonSerializer.Deserialize<List<TrabajadoresData>>(trabajadoresdata);

                foreach (var item in trabajadores)
                {
                    if (!context.Trabajadores.Any(x => x.TrabajadorNome == item.nombre))
                    {
                        var empresa = context.Empresa.Where(x => x.Nif == item.nifempresa.ToString()).FirstOrDefault();
                        var fundae = false;
                        var baja = false;
